...
(() => {
  ...
  async function applyHomeHeroSeo() {
    ...
    try {
      ...
      const res = await fetch(window.tngApiUrl('/api/news/home'), { signal: controller.signal, headers: { Accept: 'application/json' } });
  ...
  document.addEventListener('DOMContentLoaded', applyHomeHeroSeo);
})();
